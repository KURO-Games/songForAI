...
public class NotesGeneratorBase : MonoBehaviour
{
    [SerializeField, Header("ノーツを生成する元(Prefab)")]
    protected GameObject NotesPrefab = null, longNotes = null, edgeStart = null, edgeEnd = null, bar = null;

    [SerializeField, Header("生成先")]
    protected List<GameObject> NotesGen = null;

    [SerializeField]
    protected float NotesDistance = 0.001f;
    ...
    protected long BgmTimes = 0;
    protected float NotesSpeeds = 0;

    //string[] filePaths = System.IO.Directory.GetFiles(Application.streamingAssetsPath, "*.nts");
    //ノーツデータ
    protected NotesJson.MusicData musicData = new NotesJson.MusicData();
    protected bool Generated = false;
    protected bool PlayedBGM = false;
    ...
    protected void notesPositionAdd(GameObject notes, int Lane, int num)
    {
